...
def load_data(file_path):
    ...
    df.rename(columns={k: v['readable_name'] for k, v in table_config.FIELD_MAPPING.items()}, inplace=True)
    ...
    fields = {v['readable_name']: v['data_type'] for v in table_config.FIELD_MAPPING.values()}
...
if __name__ == "__main__":
    ...
    irs_soi_stats_data_file = os.path.join(ROOT_DIR, 'src_input/irs', '2023-05-19_14.11.58-20zpallnoagi.csv')
